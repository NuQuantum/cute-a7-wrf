...
ipbus_compile_project :
	./tools/tcl/run_cute_a7_tcl.sh compile_project "$(cute_a7_ipbus_dir)/cute_a7_ipbus.xpr"

ipbus_update_elf:$(WRPC_SW_PATH) $(cute_a7_ipbus_bit_tgt) 
	updatemem -meminfo $(cute_a7_ipbus_top)/cute_a7_ipbus.mmi -data $(WRPC_SW_PATH) \
	-bit $(cute_a7_ipbus_bit_tgt) -proc dummy -out $(cute_a7_ipbus_elf_bit_tgt) -force
	rm updatemem.log
	rm updatemem.jou

ipbus_flash: $(cute_a7_ipbus_bit_tgt)
	./tools/tcl/run_cute_a7_tcl.sh generate_mcs $< $(cute_a7_ipbus_mcs_tgt)

ipbus_flash_elf: $(cute_a7_ipbus_elf_bit_tgt)
	./tools/tcl/run_cute_a7_tcl.sh generate_mcs $< $(cute_a7_ipbus_elf_mcs_tgt)

ipbus_program: $(cute_a7_ipbus_bit_tgt)
	./tools/tcl/run_cute_a7_tcl.sh program_fpga $<

ipbus_program_elf: $(cute_a7_ipbus_elf_bit_tgt)
	./tools/tcl/run_cute_a7_tcl.sh program_fpga $<

ipbus_program_flash: $(cute_a7_ipbus_mcs_tgt)
	./tools/tcl/run_cute_a7_tcl.sh program_flash $<

ipbus_program_flash_elf: $(cute_a7_ipbus_elf_mcs_tgt)
	./tools/tcl/run_cute_a7_tcl.sh program_flash $<

gmii_compile_project :
	./tools/tcl/run_cute_a7_tcl.sh compile_project "$(cute_a7_gmii_dir)/cute_a7_gmii.xpr"

gmii_update_elf:$(WRPC_SW_PATH) $(cute_a7_gmii_bit_tgt) 
	updatemem -meminfo $(cute_a7_gmii_top)/cute_a7_gmii.mmi -data $(WRPC_SW_PATH) \
	-bit $(cute_a7_gmii_bit_tgt) -proc dummy -out $(cute_a7_gmii_elf_bit_tgt) -force
	rm updatemem.log
	rm updatemem.jou

gmii_flash: $(cute_a7_gmii_bit_tgt)
	./tools/tcl/run_cute_a7_tcl.sh generate_mcs $< $(cute_a7_gmii_mcs_tgt)

gmii_flash_elf: $(cute_a7_gmii_elf_bit_tgt)
	./tools/tcl/run_cute_a7_tcl.sh generate_mcs $< $(cute_a7_gmii_elf_mcs_tgt)
...
golden_compile_project :
	./tools/tcl/run_cute_a7_tcl.sh compile_project "$(cute_a7_golden_dir)/cute_a7_gmii.xpr"
...
golden_flash: $(cute_a7_golden_bit_tgt)
	./tools/tcl/run_cute_a7_tcl.sh generate_mcs $< $(cute_a7_golden_mcs_tgt)

golden_flash_elf: $(cute_a7_golden_elf_bit_tgt)
	./tools/tcl/run_cute_a7_tcl.sh generate_mcs $< $(cute_a7_golden_elf_mcs_tgt)
...
ipbus_compile_project_35t :
	./tools/tcl/run_cute_a7_tcl.sh compile_project "$(cute_a7_ipbus_dir)/cute_a7_35t_ipbus.xpr"

ipbus_update_elf_35t:$(WRPC_SW_PATH) $(cute_a7_35t_ipbus_bit_tgt) 
	updatemem -meminfo $(cute_a7_ipbus_top)/cute_a7_35t_ipbus.mmi -data $(WRPC_SW_PATH) \
...
ipbus_flash_35t: $(cute_a7_35t_ipbus_bit_tgt)
	./tools/tcl/run_cute_a7_tcl.sh generate_mcs $< $(cute_a7_35t_ipbus_mcs_tgt)

ipbus_flash_elf_35t: $(cute_a7_35t_ipbus_elf_bit_tgt)
	./tools/tcl/run_cute_a7_tcl.sh generate_mcs $< $(cute_a7_35t_ipbus_elf_mcs_tgt)
...
gmii_compile_project_35t :
	./tools/tcl/run_cute_a7_tcl.sh compile_project "$(cute_a7_gmii_dir)/cute_a7_35t_gmii.xpr"

gmii_update_elf_35t:$(WRPC_SW_PATH) $(cute_a7_35t_gmii_bit_tgt) 
	updatemem -meminfo $(cute_a7_gmii_top)/cute_a7_35t_gmii.mmi -data $(WRPC_SW_PATH) \
	-bit $(cute_a7_35t_gmii_bit_tgt) -proc dummy -out $(cute_a7_35t_gmii_elf_bit_tgt) -force
	rm updatemem.log
	rm updatemem.jou

gmii_flash_35t: $(cute_a7_35t_gmii_bit_tgt)
	./tools/tcl/run_cute_a7_tcl.sh generate_mcs $< $(cute_a7_35t_gmii_mcs_tgt)

gmii_flash_elf_35t: $(cute_a7_35t_gmii_elf_bit_tgt)
	./tools/tcl/run_cute_a7_tcl.sh generate_mcs $< $(cute_a7_35t_gmii_elf_mcs_tgt)
...
golden_compile_project_35t :
	./tools/tcl/run_cute_a7_tcl.sh compile_project "$(cute_a7_golden_dir)/cute_a7_35t_gmii.xpr"
...
golden_flash_35t: $(cute_a7_35t_golden_bit_tgt)
	./tools/tcl/run_cute_a7_tcl.sh generate_mcs $< $(cute_a7_35t_golden_mcs_tgt)

golden_flash_elf_35t: $(cute_a7_35t_golden_elf_bit_tgt)
	./tools/tcl/run_cute_a7_tcl.sh generate_mcs $< $(cute_a7_35t_golden_elf_mcs_tgt)
